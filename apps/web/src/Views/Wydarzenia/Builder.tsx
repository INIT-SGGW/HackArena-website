        ...
        eventData.blocks.map((item, index) => {
          switch (item.type) {
            ...
            case EventComponents.PRIZES:
              return <Prizes key={index} data={item.data as PrizesType} />;
            case EventComponents.HIGHLIGHTS:
              return (
                <Highlights key={index} data={item.data as HighlightsType} />
              );
            ...
            case EventComponents.RESULTS:
              return <Results key={index} data={item.data as ResultsType} />;
            case EventComponents.SPONSORS:
              return <Sponsors key={index} data={item.data as SponsorsType} />;
            case EventComponents.PHOTOS:
              return (
                <PhotoGallery key={index} data={item.data as PhotosType} />
              );
            default:
              return null;
          }
