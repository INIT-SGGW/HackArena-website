...
export default function LoginForm() {
  return (
    <div className={' font-jet-brains font-bold '}>
      <h1 className={"justify-self-center text-primary mb-10 text-5xl"}>Logowanie</h1>
      <div
        className={
      ...
      >
        <div className={'p-5'}>
          ...
          <div
            className={
              'content-card-clip bg-primary text-secondary-300 text-black flex items-center justify-center min-h-[35px]'
            }
            style={{ '--clip-size': '14px' }}
          >
