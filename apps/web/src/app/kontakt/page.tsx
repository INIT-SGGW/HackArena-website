...
export default function Contact() {
  return (
    <div className={"  md:relative justify-center  font-jet-brains md:scale-65    "}>

      <div
        className=" justify-self-center max-w-[450px]   md:max-w-[1000px] md:max-h-[600px] flex flex-col gap-y-10   md:absolute top-0  ">
        ...
        <div className={"flex flex-col gap-y-10 md:flex md:flex-row md:justify-between md:items-stretch md:gap-x-15 "}>
          <div
            className={"content-card-clip bg-secondary-300  md:flex-1 md:min-w-0 "}>
            <div className={"p-5 md:py-5 md:px-8 md:flex-grow "}>
              <h1 className={"text-3xl font-black text-primary  md:text-4xl"}>
                Kontakt ogólny
              </h1>
              <p className={"text-xl text-black  text-secondary-100 md:text-2xl pt-8  "}>
                Jeśli masz pytania ogólne lub problem z rejestracją, napisz na
                adres:
              </p>
              <div className={"flex flex-row py-5 md:py-8  flex-shrink md:pt-8 md:pb-2 "}>
                <Image
                  src={"mail.svg"}
                  alt="mail"
                  width="22"
                  ...
                  className={""}
                />
                <a className={"   text-xl  md:text-xl px-4"} href={"mailto:kontakt@hackrena.pl"}>
                  kontakt@hackarena.pl
                </a>
              </div>
            </div>
          </div>
          <div className={"content-card-clip bg-secondary-300  md:flex-grow md:flex-1 md:min-w-0 md:relative"}>
            <div className={"p-5 md:py-5 md:px-8"}>
              <h1 className={" text-3xl font-black text-primary  md:text-4xl "}>
                Współpraca
              </h1>
              <div className={"md:flex md:flex-col md:justify-between"}></div>
              <p className={"text-lg text-black  text-secondary-100 md:text-2xl pt-8 "}>
                Jeśli jesteś zainteresowany współpracą z nami, napisz na adres:
              </p>
              <div className={"flex flex-row md:self-end  py-4 md:pt-8 md:pb-2 md:flex-grow md:absolute md:bottom-5"}>
                <Image
                  src={"mail.svg"}
                  alt="mail"
                  width="22"
                  ...
                  className={""}
                />
                <a className={"   text-lg  md:text-xl px-4"} href={"mailto:wspolpraca@hackrena.pl"}>
