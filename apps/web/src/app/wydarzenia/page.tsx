  ...
  return (
    <div>
      <div className={'w-full h-full justify-self-center'}>
        <div className={'mx-2 justify-self-center'}>
          <div className={' flex flex-col'}>
            ...
            <div
              className={
                'content-card-clip bg-primary flex-grow  w-full h-ful max-w-[343px] self-center'
              }
              style={{ '--clip-size': '20px' }}
            >
              <div className={'px-5 py-3'}>
                ...
                <div className={'flex flex-row text-secondary-300 pt-3'}>
                  <Image
                    src={'two-arrows-black.svg'}
                    alt={'two arrows'}
                    width={30}
                    height={30}
                  ></Image>
                  <a
                    className={'pl-2 font-extrabold text-lg'}
                    href={'wydarzenia/hackArena_2.5'}
                  >
                    Dowiedz się więcej
                  </a>
                </div>
