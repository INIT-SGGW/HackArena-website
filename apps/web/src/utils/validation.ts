import { z } from 'zod';
import { Occupation } from '../types/dtos';

const passwordSchema = z
    .string()
    .nonempty({ message: "Hasło jest wymagane" })
...
const registerPasaswordSchema = z
    ...
    .refine((password) => /[0-9]/.test(password), { message: "Hasło musi zawierać co najmniej jedną liczbę" })
