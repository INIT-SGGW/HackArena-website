...
export default function VerificationCard(): React.JSX.Element {
    ...
    useEffect(() => {
        ...
        const handle = async (): Promise<void> => {
            try {
                await fetcherAuth<void>(`/register/verifiy?email=${email}&token=${token}`, {
                    method: "POST",
                    body: JSON.stringify({
                        email: email,
    ...
    if (!email || !token) {
        return (
            <div className="flex flex-col items-center justify-center gap-4 mx-auto text-center page-width">
                ...
                <p className="text-white">Link weryfikacyjny jest nieprawidłowy. Skontaktuj się z nami na <a href="mailto:kontakt@hackarena.pl" className="text-primary">kontakt@hackarena.pl</a></p>
                <LinkButton href="/" className="mt-8">Wróć na stronę główną</LinkButton>
            </div>
        )
    }
        ...
        return (
            <div className="flex flex-col items-center justify-center gap-4 mx-auto text-center page-width">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <p className="text-white">Skontaktuj się z nami na <a href="mailto:kontakt@hackarena.pl" className="text-primary">kontakt@hackarena.pl</a></p>
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-4 mx-auto text-center page-width">
            ...
            <LinkButton href="/login" className="mt-8">Zaloguj się</LinkButton>
        </div>
    )
}
